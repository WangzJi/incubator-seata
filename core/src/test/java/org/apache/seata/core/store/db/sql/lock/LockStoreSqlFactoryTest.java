...
public class LockStoreSqlFactoryTest {
    ...
    private static LockStoreSql MARIADB_LOCK_STORE = LockStoreSqlFactory.getLockStoreSql("mariadb");
    ...
    private static LockStoreSql DM_LOCK_STORE = LockStoreSqlFactory.getLockStoreSql("dm");

    private static LockStoreSql OSCAR_LOCK_STORE = LockStoreSqlFactory.getLockStoreSql("oscar");
