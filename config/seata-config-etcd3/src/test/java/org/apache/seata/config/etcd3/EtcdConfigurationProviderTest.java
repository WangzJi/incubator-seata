...
class EtcdConfigurationProviderTest {

    @Test
    void testProvide() {
        EtcdConfigurationProvider provider = new EtcdConfigurationProvider();
        Configuration config = provider.provide();

        Assertions.assertNotNull(config);
        Assertions.assertInstanceOf(EtcdConfiguration.class, config);
    }
